...
CREATE TABLE IF NOT EXISTS equipamento(
    ...
    CONSTRAINT fkgrupo_muscular FOREIGN KEY(grupo_muscular_id) references grupo_muscular(id),
...
INSERT INTO aluno(personal_id,usuario_id, data_nascimento, sexo, objetivo_principal, observacao, criado_em, data_inicio, nivel) VALUES ('1','1','2009-10-19','feminino','Melhorar o Fisico','tendao estorado','2026-09-22','2026-09-22','iniciante'),
('1','2','2000-03-30','masculino','não tem','não tem','2026-09-22','2026-09-22','intermediario');
